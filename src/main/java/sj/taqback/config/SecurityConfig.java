...
public class SecurityConfig {
    ...
    private final PasswordEncoder secureBCryptPasswordEncoder
            = new SecureBCryptPasswordEncoder(MIN_STRENGTH, LIMIT_STRENGTH);

    @Bean
    public PasswordEncoder passwordEncoder() {
        return secureBCryptPasswordEncoder;
    }
}
